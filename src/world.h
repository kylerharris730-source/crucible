...
/* A fumarole's eruption rate moved into g_matVentsFire when the wood ember
   wanted the same behaviour -- see materials.cpp, where the number and the
   argument for it now live together. */
