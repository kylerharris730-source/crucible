...
SRC := src/common.cpp src/materials.cpp src/world.cpp src/render.cpp src/player.cpp src/item.cpp src/sprite.cpp src/worldgen.cpp src/light.cpp src/room.cpp src/device.cpp src/projectile.cpp src/main.cpp
